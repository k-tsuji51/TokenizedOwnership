...
public class StringUtil {
	...
	public static final String INPUT_CLONESET_FILELIST = "inputclonesetfilelist";
	public static final String REMOVE_HEAD = "removehead";



	public static final String TOKENIZED_LOGFILE = "tokenizedLogFile.txt";
	...
	public static final String CSV_OUTPUT = "result.csv";
}
